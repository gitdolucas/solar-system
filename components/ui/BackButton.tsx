...
export function BackButton({ dense }: { dense?: boolean }) {
  ...
  return (
    <button
      ...
      style={{
        ...
        alignItems: 'center',
        gap: dense ? '4px' : '6px',
        padding: dense ? '3px 6px 3px 5px' : '5px 10px 5px 8px',
    ...
    >
      <svg width={dense ? 8 : 10} height={dense ? 8 : 10} viewBox="0 0 10 10" fill="none" aria-hidden="true">
